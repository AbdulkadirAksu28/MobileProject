...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Project_Mobile_Abdulkadir_Aksu.Android.dll" comes first in this list. */
		"Project_Mobile_Abdulkadir_Aksu.Android.dll",
		"Firebase.Auth.dll",
		"Firebase.dll",
		"FireSharp.dll",
		"FormsViewGroup.dll",
		...
		"Newtonsoft.Json.dll",
		"Project_Mobile_Abdulkadir_Aksu.dll",
