...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Mobile_Project_Abdulkadir_Aksu.Android.dll" comes first in this list. */
		"Mobile_Project_Abdulkadir_Aksu.Android.dll",
		"Firebase.dll",
		"FormsViewGroup.dll",
		"LiteDB.dll",
		"Mobile_Project_Abdulkadir_Aksu.dll",
		"Newtonsoft.Json.dll",
		"System.Reactive.dll",
